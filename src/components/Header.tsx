...
const Header = () => {
  return <header className="fixed top-0 left-0 right-0 z-50 bg-hero/95 backdrop-blur-sm border-b border-white/10">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#process" className="text-hero-foreground/80 hover:text-hero-foreground transition-colors" onClick={e => {
          e.preventDefault();
          ...
          <a href="#pricing" className="text-hero-foreground/80 hover:text-hero-foreground transition-colors" onClick={e => {
          e.preventDefault();
